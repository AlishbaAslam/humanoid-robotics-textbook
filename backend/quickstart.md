# Quickstart Guide: Docusaurus Content Ingestion Pipeline

This guide provides instructions to quickly set up and run the Docusaurus content ingestion system.
...
BASE_URL=https://alishbaaslam.github.io/humanoid-robotics-textbook/
```
